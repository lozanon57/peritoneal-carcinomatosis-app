...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'PC & CRS+HIPEC — Peritoneal Carcinomatosis',
        short_name: 'PC+HIPEC',
        description: 'E-Learning platform for peritoneal carcinomatosis, CRS+HIPEC and PIPAC — Dr. Pablo Lozano Lominchar, MSKCC Fellow 2024-25',
        theme_color: '#0d9488',
